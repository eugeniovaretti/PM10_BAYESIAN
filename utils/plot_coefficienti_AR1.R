plot_coefficienti_AR1 = function(coefficienti, label1, label2, xlab = "Stations", ylab = "AR1 coefficients")
{
  library(viridis)
  ...
  plot1 = plot(coefficienti, col=colori1, pch=19, xlab = xlab, ylab = ylab)
  ...
  plot2 = plot(coefficienti, col=colori2, pch=19, xlab = xlab, ylab = ylab)
